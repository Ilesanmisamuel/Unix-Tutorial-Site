...
<div class="sidenav">
        <div class="slidenav">
            ...
            <a href="game2.php">
                <div class="sidebuts active side4">
                    <p>Game Two</p>
                </div>
            </a>
            <a href="lesson3.php">
...
<div class="content">
  ...
  <div id="dontshow">
    <img id="bg" src="assets/imgs/kitchen2-01.png" />
    ...
    <img id="tomato2" src="assets/imgs/tomato2.png" />
    <img id="lettuce2" src="assets/imgs/lettuce2.png" />
    <img id="burger2" src="assets/imgs/burger2.png" />
    <img id="bacon2" src="assets/imgs/bacon2.png" />
    <img id="cheese2" src="assets/imgs/cheese2.png" />
  </div>
</div> <!-- End Content -->
