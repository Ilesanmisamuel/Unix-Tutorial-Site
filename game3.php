...
<div class="sidenav">
        <div class="slidenav">
            ...
            <a href="game3.php">
                <div class="sidebuts active side6">
                    <p>Game Three</p>
                </div>
            </a>
        </div>
...
<div class="content">
  ...
  <div id="dontshow">
    <img id="bg" src="assets/imgs/kitchen3-01.png" />
    ...
    <img id="tomato2" src="assets/imgs/tomato3.png" />
    <img id="lettuce2" src="assets/imgs/lettuce3.png" />
    <img id="burger2" src="assets/imgs/burger3.png" />
    <img id="bacon2" src="assets/imgs/bacon3.png" />
    <img id="cheese2" src="assets/imgs/cheese3.png" />
  </div>
</div> <!-- End Content -->
